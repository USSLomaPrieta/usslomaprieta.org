		...
		<div id="container" class="container">  
			<div class="span-24">
				<div class="span-17">
                    ...
                    if(function_exists('wp_nav_menu')) {
                        wp_nav_menu( 'depth=1&theme_location=primary&menu_id=pagemenu&container=&fallback_cb=menu_1_default');
                    } else {
                        menu_1_default();
                    }
				...
				<div id="header" class="span-24" <?php
                    $header_background = get_theme_option('header_background');
                    if($header_background !='') {
                        ?> style="background: url(<?php echo $header_background; ?>) top right no-repeat;" <?php
                    }
                ?>>
						<?php
		 ...
		 <div class="span-24">
				...
				<div id="navcontainer">
					<?php
                    if(function_exists('wp_nav_menu')) {
                            wp_nav_menu( 'theme_location=secondary&menu_id=nav&container=&fallback_cb=menu_2_default');
                        } else {
                            menu_2_default();
                        }
